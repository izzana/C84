...
export default class SearchScreen extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      allTransactions: [],
      searchText: "", //para limpar a barra de pesquisa no início
  ...
  renderItem = ({ item, i }) => {
    var date = item.date
      .toDate() //convertemos a data do registro de data/hora 
      //em uma string legível normal quando o livro estiver sendo
      //entregue ou devolvido pelo aluno. 
      .toString() 
      .split(" ") //convertendo o dado, dividindo a string em uma matriz
      .splice(0, 4) //separando o índice
      .join(" "); //juntando todos os índices
